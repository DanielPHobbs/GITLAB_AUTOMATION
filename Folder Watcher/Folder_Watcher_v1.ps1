...
[String]$Scriptname="Folder_Watcher_v1"
...
AppendLog  "Scanning Folder $FolderPath for files"
$fileProperties=@()
$fileLoad = Get-ChildItem $folderPath | Select-Object *

Foreach ($file in $Fileload){
...
$fileProperties += "$Basename" + "," + "$extension" + "," + "$name" + "," + "$DirectoryName" + "," + "$creationTime" + "," + "$lastwritetime"   | ConvertTo-Xml

}

$fileProperties.InnerXml
AppendLog  "Completed Scanning Folder $FolderPath for files"
